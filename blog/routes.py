...
import secrets
import os
from blog.forms import RegistrationForm, LoginForm, PostForm, RequestResetForm, ResetPasswordForm, UpdateAccountForm
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request',
                  sender='ihassib@gmail.com', recipients=[user.email])
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been set with instruction to reset your password', 'info')
        return redirect(url_for('login'))
